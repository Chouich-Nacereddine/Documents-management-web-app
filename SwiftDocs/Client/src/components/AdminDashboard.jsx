        ...
        <div className="pt-1 ">
            <div className="bg-[#1D1F21] text-white h-screen flex overflow-hidden text-sm ">
                ...
                <div className="flex-grow overflow-hidden h-full flex flex-col">
                        ...
                        <div className={`flex h-full text-gray-400 ${SideBar_activeIndex !== 1? "hidden" : ""}`}>
                            {SecondNavBar.map((item, index) => (
                                <a
                                    ...
                                    className={`cursor-pointer h-full inline-flex items-center mr-8 text-xl ${
                                        FirstNavBar_activeIndex === index
                                            ? "border-b-2 text-white border-white w-[max-content]"
                                            : ""
                                    }`}
                    ...
                    <div
                        className={`" ${
                            FirstNavBar_activeIndex !== 2 || SideBar_activeIndex !== 1? "hidden" : ""
                        } "`}
                    >
                        <ProcessAdd/>
                    </div>
                    <div
                        className={`" ${
                            FirstNavBar_activeIndex !== 3 || SideBar_activeIndex !== 1? "hidden" : ""
                        } "`}
                    >
                        <ProcessEdit/>
                    </div>
                    <div
                        className={`" ${
                            FirstNavBar_activeIndex !== 4 || SideBar_activeIndex !== 1? "hidden" : ""
                        } "`}
                    >
                        <ProcessSearch/>
                    </div>
                    ...
                    <div
                        className={`" ${
                            FirstNavBar_activeIndex !== 3 || SideBar_activeIndex !== 2? "hidden" : ""
                        } "`}
                    >
                        <FileValidation/>
                    </div>
