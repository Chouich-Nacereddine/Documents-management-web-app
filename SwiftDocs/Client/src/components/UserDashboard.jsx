...
const UserDashboard = () => {
    ...
    return (
        <div className="pt-1 ">
            <div className="bg-[#1D1F21] text-white h-screen flex overflow-hidden text-sm z-[-100]">
                <LeftSideBar />
                <div className="flex-grow overflow-hidden h-full flex flex-col">
                    <TopNavBar />
                    <div className="flex-grow flex overflow-x-hidden ">
                        <div className="xl:w-72 w-48 flex-shrink-0 border-r border-gray-800 h-full overflow-y-auto lg:block hidden p-5 scrollbar-hide">
                            ...
                            <div className="space-y-4 mt-3">
                                {UsersSidebarArray.map((item, index) => (
                                    ...
                                    >
                                        <div className="flex xl:flex-row flex-col items-center font-medium text-gray-900 text-white pb-2 mb-2 xl:border-b  border-opacity-75 border-gray-700 w-full">
                                            <img
                        ...
                        <div className="flex-grow bg-[#1D1F21] overflow-y-auto">
                            <div className="sm:px-7 sm:pt-7 px-4 pt-4 flex flex-col w-full border-b bg-[#1D1F21] text-white border-gray-800 sticky top-0">
                                    ...
                                    {SecondeNavBarArray.map((item, index) => (
                                        <div key={index}>
                                            <a
                                                href="#"
                                                onClick={() =>
                                                    SecondeNavBar_handleSpanClick(
                                                        index
                                                    )
                                                }
                                                className={`"px-3  pb-1.5 " ${
                                                    SecondeNavBar_activeIndex ===
                                                    index
